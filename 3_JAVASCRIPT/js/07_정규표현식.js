...
document.getElementById("check1").addEventListener("click", function(){
    ...
    console.log("regEx1.exec(str2) : " + regEx1.test(str2));
    console.log("regEx1.exec(str2) : " + regEx1.exec(str2));

    console.log("regEx1.exec(str3) : " + regEx1.test(str3));
    ...
    console.log("regEx2.exec(str2) : " + regEx1.test(str2));
    console.log("regEx2.exec(str2) : " + regEx1.exec(str2));

    console.log("regEx2.exec(str3) : " + regEx1.test(str3));
...
document.getElementById("check2").addEventListener("click", function(){
    ...
    // ^[abcd] : 문자열의 a,b,c,d 중 하나로 시작하는지 검색
    const regEx3 = /^[abcd]/;
...
document.getElementById("inputName").addEventListener("keyup", function(){
    ...
    if(regEx.test(this.value)){ // 유효하면
        result1.innerText = "유효한 이름 형식 입니다."
